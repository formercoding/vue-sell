<template>
  ...
  <div v-show="showFlag" class="food" ref=foodCom>
    <div class="food-content">
      ...
      <div class="rating">
        ...
        <rating :select-type="selectType" :only-content="onlyContent" :desc="desc" :ratings="food.ratings"></rating>
        <div class="rating-wrapper">
          <ul class="no-rating" v-show="food.ratings">
  ...
  export default {
    ...
    methods: {
      show() {
        ...
        this.$nextTick(() => {
          if (!this.scroll) {
            this.scroll = new BScroll(this.$refs.foodCom, { click: true });
          } else {
            this.scroll.refresh();
          }
        });
